...
if __name__ == "__main__": 
    ...
    if train:
        ...
        train_matrices_names_list = fnmatch.filter(os.listdir('/home/pro2future/Documents/PIE-NET_Dataset_Preparation/mat_after_main1_ohneKreis_ohneAmbg/'), '*.mat')
    ...
    with open("file.json", 'r') as f:
        train_matrices_names_list = json.load(f)
        train_matrices_names_list_num = len(train_matrices_names_list)
        ...
        for k in tqdm(range(train_matrices_names_list_num)):
            ...
            loadpath = "/home/pro2future/Documents/PIE-NET_Dataset_Preparation/mat_after_main1_ohneKreis_ohneAmbg/" + train_matrices_names_list[k]
            ...
            while i < end_count:
                ...
                color_array[np.where(edge_points_label[:, 0])[0], ...] = [0.0, 0.70, 0.0]
                color_array[np.where(corner_points_label[:, 0])[0], ...] = [0.99, 0.99, 0.0]
                corner_points_label
                ...
                vis.create_window()
                vis.register_key_callback(89, close_visualization_yes) # y
                vis.register_key_callback(78, close_visualization_no) # n
