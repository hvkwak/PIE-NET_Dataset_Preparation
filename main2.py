...
def main():
    ...
    slice_mat = fnmatch.filter(os.listdir('/raid/home/hyovin.kwak/PIE-NET_Dataset_Preparation/mat_after_main1/test_slice'), '*.mat')
    train_matrices_names_list = slice_mat + train_matrices_names_list
